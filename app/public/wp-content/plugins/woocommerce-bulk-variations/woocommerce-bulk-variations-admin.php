	...
	public function add_meta_box() {
		...
		if ( $post && $post->post_type == 'product' ) {
			...
			if ( empty( $product ) || ! $product->is_type( 'variable' ) ) {
				...
				add_meta_box( 'woocommerce-bulk-variations', __( 'Bulk Variation Input', 'woocommerce-bulk-variations' ), array(
					$this,
					'meta_box'
        ...
        <div id="product_views" class="panel">
            <div class="woocommerce_product_views">
				...
				<?php else : ?>
                    ...
                    <p>
                        <label class=""><?php _e( 'Bulk Variation Form:', 'woocommerce-bulk-variations' ); ?></label>
                    ...
                    <p>
                        <label class=""><?php _e( 'Singular Variation Form:', 'woocommerce-bulk-variations' ); ?></label>
                    ...
                    <p>
                        <label class=""><?php _e( 'Columns:', 'woocommerce-bulk-variations' ); ?></label>
                    ...
                    <p>
                        <label class=""><?php _e( 'Rows:', 'woocommerce-bulk-variations' ); ?></label>
