...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '4.9.0', __( 'WooCommerce URL Coupons', 'woocommerce-url-coupons' ), __FILE__, 'init_woocommerce_url_coupons', array(
...
class WC_URL_Coupons extends SV_WC_Plugin {
	...
	public function get_settings_url( $plugin_id = null ) {
		...
		return SV_WC_Plugin_Compatibility::is_wc_version_gte( '3.4.0' ) ? admin_url( 'admin.php?page=wc-settings&tab=general' ) : admin_url( 'admin.php?page=wc-settings&tab=checkout' );
	}
