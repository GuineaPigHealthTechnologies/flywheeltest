...
// Plugin updates
woothemes_queue_update( plugin_basename( __FILE__ ), '79ca7aadafe706364e2d738b7c1090c4', '675790' );
...
if ( ! class_exists( 'WC_Store_Catalog_PDF_Download' ) ) :
	...
	define( 'WC_STORE_CATALOG_PDF_DOWNLOAD_VERSION', '1.0.14' );
	...
	class WC_Store_Catalog_PDF_Download {
		...
		public function woocommerce_missing_notice() {
			echo '<div class="error"><p>' . sprintf( __( 'WooCommerce Store Catalog PDF Download Plugin requires WooCommerce to be installed and active. You can download %s here.', 'woocommerce-store-catalog-pdf-download' ), '<a href="http://www.woothemes.com/woocommerce/" target="_blank">WooCommerce</a>' ) . '</p></div>';
		}
