...
if (is_woocommerce_active()) {
	add_filter( 'woocommerce_ajax_layered_nav_term_link', 'ajax_layered_nav_maybe_preserve_brand_filter' );
	 ...
	 * @return string
	 */
	function ajax_layered_nav_maybe_preserve_brand_filter( $link ) {
