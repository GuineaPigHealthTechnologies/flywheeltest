...
class sb_et_woo_li_checkout_billing_module extends ET_Builder_Module
{
    function init()
    {
        $this->name = __('Woo Checkout Billing', 'et_builder');
        $this->slug = 'et_pb_woo_checkout_billing';
        ...
        $this->advanced_options = array(
            'fonts' => array(
                'ctnt' => array(
                    ...
                    'css' => array(
                        'main' => "{$this->main_css_element} p label, {$this->main_css_element} label, {$this->main_css_element} a, {$this->main_css_element} td, {$this->main_css_element} th",
                    ),
    ...
    function shortcode_callback($atts, $content = null, $function_name)
    {
        ...
        if ($content) {
            $output = '<div ' . ($module_id ? 'id="' . esc_attr($module_id) . '"' : '') . ' class="' . $module_class . ' clearfix ' . ($title ? 'has_title':'') . ' et_pb_module et_pb_woo_checkout_fields et_pb_woo_checkout_billing">' . $content . '</div>';
        }
...
new sb_et_woo_li_checkout_billing_module();
