...
class sb_et_woo_li_upsell_module extends ET_Builder_Module
{
    function init()
    {
        $this->name = __('Woo Upsell', 'et_builder');
        $this->slug = 'et_pb_woo_upsell';
    ...
    function shortcode_callback($atts, $content = null, $function_name)
    {
        ...
        if ($use_loop == 'on') {
            ...
            if ($upsells = $product->get_upsell_ids()) {
                ...
                $args = array('post_type' => 'product', 'posts_per_page' => $to_show, 'post__in' => $upsells);
            ...
            woocommerce_upsell_display($args);
        }
...
new sb_et_woo_li_upsell_module();
