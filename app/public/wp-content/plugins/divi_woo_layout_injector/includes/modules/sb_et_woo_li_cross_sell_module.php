...
class sb_et_woo_li_cross_sell_module extends ET_Builder_Module
{
    ...
    function shortcode_callback($atts, $content = null, $function_name)
    {
        ...
        $output = '';
        $module_class = 'woocommerce ' . ET_Builder_Element::add_module_order_class($module_class, $function_name);
        ...
        if ($use_loop == 'on') {
            ...
            if ($cross_sells = WC()->cart->get_cross_sells()) {
                ...
                $args = array('post_type' => 'product', 'posts_per_page' => $to_show, 'post__in' => $cross_sells);
            ...
            woocommerce_cross_sell_display($to_show, $to_show);
        }
