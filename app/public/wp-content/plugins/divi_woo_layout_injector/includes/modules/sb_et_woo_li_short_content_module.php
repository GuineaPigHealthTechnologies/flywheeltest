...
class sb_et_woo_li_short_content_module extends ET_Builder_Module
{
    function init()
    {
        $this->name = __('Woo Short Content', 'et_builder');
    ...
    function shortcode_callback($atts, $content = null, $function_name)
    {
        ...
        if ($content) {
            ...
            $output = sprintf(
                ...
                'clearfix ',
                $content,
                esc_attr('et_pb_module et_pb_woo_text et_pb_woo_short_text et_pb_text et_pb_bg_layout_' . $background_layout . ' et_pb_text_align_' . $text_orientation),
                '</div>',
...
new sb_et_woo_li_short_content_module();
