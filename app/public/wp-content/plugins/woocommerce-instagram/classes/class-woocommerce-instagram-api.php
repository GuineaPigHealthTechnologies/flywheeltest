...
class Woocommerce_Instagram_API {
	 ...
	 * @var string
	 */
	protected $_token = 'woocommerce-instagram';
	...
	public function get_self_media_recent( $args ) {
		$data = '';
		$transient_key = 'self-media-recent';
	...
	/**
	 * Retrieve recent photos for the connected user.
	 *
	 * @since 1.0.0
	 *
	 * @param array  $args Request args.
	 ...
	 */
	protected function _request( $endpoint, $params = array(), $method = 'post' ) {
		$return = '';
	 ...
	 */
	protected function _maybe_display_error( $obj ) {
