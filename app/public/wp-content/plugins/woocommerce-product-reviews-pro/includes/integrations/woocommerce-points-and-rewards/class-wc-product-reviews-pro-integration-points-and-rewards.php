...
class WC_Product_Reviews_Pro_Integration_Points_And_Rewards {
	...
	public function __construct() {
		...
		add_filter( 'wc_points_rewards_pro_post_add_product_review_points',    array( $this, 'review_add_product_review_points' ), 10, 2 );
		add_filter( 'wc_points_rewards_pro_approve_add_product_review_points', array( $this, 'review_add_product_review_points' ), 10, 2 );
	}
