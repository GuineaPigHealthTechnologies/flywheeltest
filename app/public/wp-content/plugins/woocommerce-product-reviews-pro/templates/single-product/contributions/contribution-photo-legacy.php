...
<li itemscope itemtype="http://schema.org/ImageObject" <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
	...
	<div id="comment-<?php comment_ID(); ?>" class="comment_container">
		...
		<div class="comment-text">
			...
			<?php if ( $title = $contribution->get_title() ) : ?>
				<h3 class="contribution-title photo-title" itemprop="name"> <?php echo esc_html( $title ); ?></h3>
			<?php endif; ?>
