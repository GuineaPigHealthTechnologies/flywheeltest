...
<li itemscope itemtype="http://schema.org/Question" <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
	...
	<div id="comment-<?php comment_ID(); ?>" class="comment_container">
		...
		<div class="comment-text">
			...
			<h3 class="contribution-title question-title"><?php esc_html_e( 'Question', 'woocommerce-product-reviews-pro' ); ?></h3>
