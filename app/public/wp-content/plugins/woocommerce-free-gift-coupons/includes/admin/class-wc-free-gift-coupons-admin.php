...
class WC_Free_Gift_Coupons_Admin {
	 ...
	 * @var string
	 */
	public static $version = '2.0.0-beta';
	...
	public static function coupon_options( $coupon_id, $coupon ) {
		...
		<p class="form-field show_if_free_gift">
			...
			<label for="free_gift_ids"><?php _e( 'Free Gifts', 'wc_free_gift_coupons' ) ?></label>

			<span class="description"><?php _e( 'These are the products you are giving away with this coupon. They will automatically be added to the cart.', 'wc_free_gift_coupons' ); ?></span>		
		...
		<table id="wc-free-gift-table"></table>
			<noscript><?php _e( 'Javascript is required for product selection to work.', 'wc_free_gift_coupons' );?></noscript>
		</div>
	...
	public static function print_templates() {
		...
		<script type="text/template" id="tmpl-wc-free-gift-products-table-header">	
			<thead>
				<tr>
					<th><?php _e( 'Product', 'wc_free_gift_coupons' );?></th>
					<th><?php _e( 'Quantity', 'wc_free_gift_coupons' );?></th>
					<th>&nbsp;</th>
				</tr>
			</thead>
			<tbody></tbody>
