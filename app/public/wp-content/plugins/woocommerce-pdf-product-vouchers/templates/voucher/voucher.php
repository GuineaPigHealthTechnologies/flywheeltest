...
<body <?php body_class( ! $image_url ? 'voucher-no-image' : null ); ?>>
	...
	<div id="no-image-message">
		<p><?php esc_html_e( 'Please set the voucher image to see the preview.', 'woocommerce-pdf-product-vouchers' ); ?></p>
	</div>
	<?php endif; ?>
	...
	<div id="voucher-container">
		...
		<div id="voucher">
			...
			<div id="voucher-image" class="image-container"><img src="<?php echo esc_url( $image_url ); ?>" alt="<?php esc_attr_e( 'Voucher Image', 'woocommerce-pdf-product-vouchers' ); ?>" /></div>
			<?php endif; ?>
