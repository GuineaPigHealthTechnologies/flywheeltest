...
class WC_PDF_Product_Vouchers_Order {
	...
	public static function vouchers_redeemed( WC_Order $order ) {
		return (bool) SV_WC_Order_Compatibility::get_meta( $order, '_voucher_redeemed', true );
	}
	...
	public static function mark_vouchers_redeemed( WC_Order $order, $voucher_count = 1 ) {
		...
		$order->add_order_note( _n( 'Voucher redeemed.', 'All vouchers redeemed.', $voucher_count, 'woocommerce-pdf-product-vouchers' ) );
