 ...
 * @since 3.0.0
 */
class WC_PDF_Product_Vouchers_Customize_Position_Control extends WP_Customize_Control {
	 ...
	 *
	 * @see WC_PDF_Product_Vouchers_Customize_Position_Control::content_template()
	 *
	 * @since 3.0.0
	 */
