 ...
 * @since 3.0.0
 */
class WC_PDF_Product_Vouchers_Customize_Voucher_Image_Control extends WP_Customize_Control {
	...
	private function get_default_image_ids() {
		...
		return $wpdb->get_col( "SELECT post_id FROM $wpdb->postmeta WHERE meta_key = '_is_wc_voucher_template_default_image' AND meta_value = 1" );;
	}
	...
	public function render_content() {
		...
		<div class="customize-control-content">
			...
			<div class="actions">
				...
				<button type="button" class="button new" id="wc_pdf_product_vouchers_voucher_image-button"  aria-label="<?php esc_attr_e( 'Add new voucher image', 'woocommerce-pdf-product-vouchers' ); ?>"><?php esc_html_e( 'Add new image', 'woocommerce-pdf-product-vouchers' ); ?></button>
			...
			<div class="choices">
				...
				<span class="customize-control-title uploaded-voucher-images">
					<?php esc_html_e( 'All Voucher Images', 'woocommerce-pdf-product-vouchers' ); ?>
				</span>

				<span class="customize-control-description">
					<?php esc_html_e( 'If there is more than one image, images will appear as alternative voucher image options for the customer. Click on an image to make it primary.' ); ?>
				</span>
