...
class WC_PDF_Product_Vouchers_Admin_Products {
	...
	public function product_voucher_options() {
		...
		woocommerce_wp_select( array(
			...
			'label'       => __( 'Voucher Template', 'woocommerce-pdf-product-vouchers' ),
			'description' => __( 'Select a voucher template to make this into a voucher product.', 'woocommerce-pdf-product-vouchers' ),
			'options'     => $options,
			'desc_tip'    => true,
		) );
