 ...
 *
 * In 3.0.0 renamed from \WC_PDF_Product_Vouchers_Admin_Voucher_Templates
 * to \WC_PDF_Product_Vouchers_Admin_Voucher_Templates.
 *
 * @since 1.2.0
 */
class WC_PDF_Product_Vouchers_Admin_Voucher_Templates {
	...
	public function redirect_voucher_template_to_customizer( $post ) {
		...
		if ( 'post-new.php' === $pagenow ) {
			...
			// install default settings for the template. See WC_PDF_Product_Vouchers_Customizer::add_customizer_settings()
