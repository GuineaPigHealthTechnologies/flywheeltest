...
<div class="panel-wrap woocommerce">
	...
	<div id="voucher_data" class="panel">
		...
		<h2><?php /* translators: %s - voucher number */ echo esc_html( sprintf( __( 'Voucher #%s details', 'woocommerce-pdf-product-vouchers' ), $voucher->get_voucher_number() ) ); ?></h2>
		<?php if ( $voucher->get_order() ) : ?>
			<p class="voucher_data_order"><?php /* translators: %1$s - <a> tag, %2$s - order number, %3$s - </a> tag */  printf( esc_html__( 'Purchased in %1$sOrder #%2$s%3$s', 'woocommerce-pdf-product-vouchers' ), '<a href="' . esc_url( get_edit_post_link( SV_WC_Order_Compatibility::get_prop( $voucher->get_order(), 'id' ) ) ) . '">', $voucher->get_order()->get_order_number(), '</a>' ); ?></p>
		<?php endif; ?>
		<div class="voucher_data_column_container">
			<div class="voucher_data_column">
				...
				<p class="form-field form-field-wide"><label for="voucher_date"><?php esc_html_e( 'Voucher date:', 'woocommerce-pdf-product-vouchers' ) ?></label>
				...
				<p class="form-field form-field-wide wc-order-status"><label for="voucher_status"><?php esc_html_e( 'Voucher status:', 'woocommerce-pdf-product-vouchers' ) ?></label>
