 ...
 * @since 3.0.0
 */
class WC_PDF_Product_Vouchers_Meta_Box_Voucher_Preview {
	...
	public function add_meta_box() {
		add_meta_box( 'wc-pdf-product-vouchers-voucher-preview', __( 'Voucher Preview', 'woocommerce-pdf-product-vouchers' ), array( $this, 'output' ), 'wc_voucher', 'side', 'high' );
	}
	...
	public function output() {
		...
		include( wc_pdf_product_vouchers()->get_plugin_path() . '/includes/admin/meta-boxes/views/html-voucher-preview.php' );
	}
