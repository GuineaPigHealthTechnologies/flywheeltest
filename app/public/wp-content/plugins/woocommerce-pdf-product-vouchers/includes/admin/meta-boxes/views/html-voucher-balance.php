...
<div class="wc-voucher-data-row wc-voucher-balance-actions wc-voucher-data-row-toggle">
	<p class="actions">
		...
		<?php if ( $voucher->is_editable() ) : ?>
			...
			<span class="description js-customer-changed-notice" style="display:none"><?php echo wc_help_tip( __( 'To calculate taxes or redeem this voucher, please save it first.', 'woocommerce-pdf-product-vouchers' ) ); ?></span>
		<?php elseif ( $voucher->has_status('redeemed') )  : ?>
			<span class="description"><?php echo wc_help_tip( __( 'To edit this voucher change the status back to "Pending"', 'woocommerce-pdf-product-vouchers' ) ); ?> <?php esc_html_e( 'This voucher has been fully redeemed.', 'woocommerce-pdf-product-vouchers' ); ?></span>
		<?php elseif ( $voucher->has_status('voided') )  : ?>
			...
			<span class="description"><?php echo wc_help_tip( __( 'To edit this voucher change the status back to "Pending"', 'woocommerce-pdf-product-vouchers' ) ); ?> <?php esc_html_e( 'This voucher has been voided and can no longer be redeemed.', 'woocommerce-pdf-product-vouchers' ); ?></span>
		<?php endif; ?>
