...
class WC_Memberships_Integration_Subscriptions_Admin {
	...
	public function user_membership_screen_columns( $column, $user_membership_id ) {
		...
		if ( $integration && 'member_since' === $column && 'wc_user_membership' === get_post_type( $user_membership_id ) && $integration->is_membership_linked_to_subscription( $user_membership_id ) ) {
