...
<?php do_action( 'wc_memberships_before_members_area', 'my-membership-discounts', $customer_membership ); ?>
...
<?php do_action( 'wc_memberships_after_members_area', 'my-membership-discounts', $customer_membership );
