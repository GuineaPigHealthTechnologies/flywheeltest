	...
	class WC_Give_Products {
		...
		public function display_page() {
			...
			if ( version_compare( WC_VERSION, '3.0.0', '>=' ) ) {
				...
				<?php
					if ( isset( $_GET['products'] ) ) {
						$products = array_map( 'intval', explode( ',', $_GET['products'] ) );
			...
			if ( version_compare( WC_VERSION, '2.3', '<' ) ) {
				...
				wp_enqueue_script( 'give-products', plugins_url( 'assets/scripts/give-products.js' , __FILE__ ) , array( 'jquery' ), time(), true );
