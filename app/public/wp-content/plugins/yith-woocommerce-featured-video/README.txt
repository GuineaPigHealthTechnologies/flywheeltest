...
* New: Support to WooCommerce 2.4.x
* Update: Language File
* Update: Plugin Core Framework
* Fix: Reflected Cross-Site Scripting (XSS)
* Fix: Minor Bugs
...
* Fix: error when string to remove the video URL from the admin fields
