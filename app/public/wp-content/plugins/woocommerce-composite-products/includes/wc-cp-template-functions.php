...
function wc_cp_summary_widget_content( $components, $composite, $widget_options ) {
	...
	?><div class="widget_composite_summary_elements"><?php
...
function wc_cp_summary_widget_details_wrapper_start( $components, $composite, $widget_options ) {
	...
	if ( 'fixed' === $widget_options[ 'display' ] ) {
		?><div class="widget_composite_summary_details_wrapper"><?php
	}
}
...
function wc_cp_add_current_selection_details( $component_id, $product ) {
	...
	?><div class="component_content" data-product_id="<?php echo $component_id; ?>">
		<div class="component_summary cp_clearfix"><?php
			...
			?><div class="product content summary_content <?php echo $selected_option ? 'populated' : ''; ?>"><?php
 ...
 * @param  WC_Product_Composite  $product
 */
function wc_cp_add_component_options_pagination_top( $component_id, $product ) {
	...
	if ( $component->paginate_options() ) {
		...
		wc_cp_add_component_options_pagination( $component_id, $product, array( 'top' ) );
	}
}
 ...
 * @param  WC_Product_Composite  $product
 */
function wc_cp_add_component_options_pagination_bottom( $component_id, $product ) {
	wc_cp_add_component_options_pagination( $component_id, $product, array( 'bottom' ) );
}
 ...
 * @param  array                 $classes
 */
function wc_cp_add_component_options_pagination( $component_id, $product, $classes = array() ) {
 ...
 * @param  WC_Product_Composite  $product
 */
function wc_cp_add_component_options_title( $component_id, $product ) {
 ...
 * @param  WC_Product_Composite  $composite
 */
function wc_cp_component_selections_message_paged_top( $component_id, $composite ) {
 ...
 * @param  WC_Product_Composite  $composite
 */
function wc_cp_component_selections_message_paged_bottom( $component_id, $composite ) {
...
function wc_cp_component_message( $classes ) {
	...
	if ( in_array( 'top', $classes ) ) {
		echo '<div class="scroll_show_component_details"></div>';
	}

	echo '<div class="component_message ' . esc_attr( implode( ' ', $classes ) ) . '" style="display:none"></div>';
}
...
function wc_cp_composited_product_details_simple( $product, $component_id, $composite ) {
	 ...
	 */
	$custom_data = apply_filters( 'woocommerce_composited_product_custom_data', array( 'price_tax' => WC_CP_Products::get_tax_ratios( $product ), 'image_data' => $composited_product->get_image_data() ), $product, $component_id, $component, $composite );
