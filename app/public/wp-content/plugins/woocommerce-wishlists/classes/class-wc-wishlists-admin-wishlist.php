...
class WC_Wishlists_Wishlist_Admin {
	...
	public function custom_filters() {
		...
		if ( $typenow == 'wishlist' ) {
            ...
            <select name="wishlist_status" id="wishlist_type">
                ...
                <option <?php selected( $wishlist_type, 'active' ); ?> value="active"><?php _e( 'Permanent', 'wc_wishlist' ); ?></option>
                <option <?php selected( $wishlist_type, 'temporary' ); ?> value="temporary"><?php _e( 'Temporary List', 'wc_wishlist' ); ?></option>
            </select>

            <select name="wishlist_sharing" id="wishlist_sharing">
                <option value=""><?php _e( 'Show All Sharing Types', 'wc_wishlist' ); ?></option>
                <option <?php selected( $wishlist_sharing, 'Public' ); ?> value="Public"><?php _e( 'Public', 'wc_wishlist' ); ?></option>
                <option <?php selected( $wishlist_sharing, 'Shared' ); ?> value="Shared"><?php _e( 'Shared', 'wc_wishlist' ); ?></option>
                <option <?php selected( $wishlist_sharing, 'Private' ); ?> value="Private"><?php _e( 'Private', 'wc_wishlist' ); ?></option>
            </select>
	...
	public function items_metabox( $post ) {
		...
		remove_action( 'woocommerce_applied_coupon', array( $cart, 'calculate_totals' ), 20, 0 );
						...
						if ( $_product->exists() && $item['quantity'] > 0 ) {
                            ...
                            <tr class="item <?php if ( ! empty( $class ) ) {
                                ...
                                <td class="line_cost" width="1%">
									<?php $price = apply_filters( 'woocommerce_cart_item_price', $cart->get_product_price( $_product ), $item, $item_id ); ?>
