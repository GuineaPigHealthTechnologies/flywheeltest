...
if ( is_woocommerce_active() ) {
	...
	class WC_Wishlists_Plugin {
		...
		public function account_menu_item( $items ) {
			...
			$items['account-wishlists'] = __( 'Wishlists', 'wc_wishlist' );
		...
		public function enqueue_assets() {
			wp_enqueue_script( 'woocommerce-wishlists', self::plugin_url() . '/assets/js/woocommerce-wishlists.js', array( 'jquery' ), $this->version );
			wp_enqueue_script( 'bootstrap-modal', self::plugin_url() . '/assets/js/bootstrap-modal.js', array( 'jquery' ), $this->version );
			...
			wp_enqueue_style( 'woocommerce-wishlists', self::plugin_url() . '/assets/css/woocommerce-wishlists.css', null, $this->version );
		}
