...
<div id="wl-wrapper" class="woocommerce">
        ...
        <div class="wl-form">
            <form action="" enctype="multipart/form-data" method="post">
                ...
                <table class="wl-rad-table">
                    <tr>
                        <td><input type="radio" name="wishlist_sharing" id="rad_pub" value="Public" checked="checked">
                        </td>
				...
				<?php if ( WC_Wishlists_Settings::get_setting( 'wc_wishlist_notifications_enabled', 'disabled' ) == 'enabled' ): ?>
                    ...
                    <table class="wl-rad-table">
                        ...
                        <tr>
                            <td>
                                <input type="radio" id="rad_notification_no" name="wishlist_owner_notifications" value="no">
                            </td>
	...
	<?php else: ?>
        ...
        <div class="woocommerce">
            <div class="woocommerce-error" role="alert"><?php _e('Unable to add a new list.  Review your existing lists below.', 'wc_wishlist'); ?></div>
        </div>
