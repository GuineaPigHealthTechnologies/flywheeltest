...
<div class="wccc-settings-custom">
	...
	<p class="description"><?php printf(_e('Enter the name and priority of an action where this content should be output.  See the <a href="%s">woocommerce hooks and filter reference</a> for a full list of all template actions and filters.', 'wc_conditional_content'), 'https://docs.woocommerce.com/document/introduction-to-hooks-actions-and-filters/'); ?></p>
