 ...
 * @category Admin
 * @package  WooCommerce Mix and Match Products/Admin/Meta-Boxes
 * @since    1.2.0
 * @version  1.2.0
 */
...
/**
 * WC_Mix_and_Match_Admin_Meta_Boxes Class.
 *
...
class WC_Mix_and_Match_Admin_Meta_Boxes {
	...
	public static function product_selector_filter( $options ) {
		wc_deprecated_function( 'WC_Mix_and_Match_Admin_Meta_Boxes::product_selector_filter', '1.8.0', 'WC_MNM_Install::product_selector_filter' );
	...
	public static function container_layout_options( $post_id, $mnm_product_object ) {
		...
		woocommerce_wp_select( array(
			...
			'description'   => __( 'Select the <strong>Grid</strong> option to have the thumbnails, descriptions and quantities of bundled products arranged in a grid. Recommended for displaying lots of product options.', 'woocommerce-mix-and-match-products' ),
			'desc_tip'      => true,
	...
	public static function process_mnm_data( $product ) {
		...
		if ( $product->is_type( 'mix-and-match' ) ) {
			...
			if ( ! defined( 'WC_MNM_UPDATING' ) ) {
				...
				WC_Admin_Meta_Boxes::add_admin_error( __( 'Your changes have not been saved &ndash; please wait for the <strong>WooCommerce Mix and Match Data Update</strong> routine to complete before creating new Mix and Match products or making changes to existing ones.', 'woocommerce-mix-and-match-products' ) );
			}
