...
class WC_Mix_and_Match_Admin {
	...
	public static function admin_scripts() {
		...
		if ( in_array ( $screen_id, array( 'edit-shop_order', 'shop_order' ) ) ) {
			wp_enqueue_style( 'wc_mnm_order_style', WC_Mix_and_Match()->plugin_url() . '/assets/css/mnm-edit-order.css', array( 'woocommerce_admin_styles' ) , WC_Mix_and_Match()->version );
			wp_style_add_data( 'wc_mnm_order_style', 'rtl', 'replace' );
		}
	}
