...
class WC_Product_Mix_and_Match extends WC_Product {
	...
	/**
	 * Price-specific data, used to caculate min/max product prices for display and min/max prices incl/excl tax.
	 * @var array
	 */
	...
	/**
	 * Props to store max raw price.
	 * @var mixed
	 */	
	private $max_raw_price;

	/**
	 * Props to store max raw regular price.
	 * @var mixed
	 */	
