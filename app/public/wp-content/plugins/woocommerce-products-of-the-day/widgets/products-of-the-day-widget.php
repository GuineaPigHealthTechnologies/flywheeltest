...
class Woocommerce_Widget_Products_Of_The_Day extends WP_Widget
{
    ...
    public function __construct()
    {
        $options = array(
            ...
            'description'	=> __( 'Lists the products of the day', 'woocommerce_products_of_the_day' )
        );

        // Create the widget
        parent::__construct( 'woocommerce_products_of_the_day', __( 'WooCommerce Products Of The Day', 'woocommerce_products_of_the_day' ), $options );
    ...
    public function widget( $args, $instance )
    {
        ...
        $title = apply_filters(
            'widget_title',
            ( $instance['title'] ) ? $instance['title'] : __( 'Products Of The Day', 'woocommerce_products_of_the_day' ),
            $instance,
            $this->id_base
        );
    ...
    */
    public function form( $instance )
    {
        ...
        <label for='{$this->get_field_id('show_thumbs')}'>". __('Show thumbnails', 'woocommerce_products_of_the_day') ."</label>
        </p>";
        ...
        <label for='{$this->get_field_id('show_add_to_cart')}'>". __('Show add to cart', 'woocommerce_products_of_the_day') ."</label>
        </p>";
    }
} 