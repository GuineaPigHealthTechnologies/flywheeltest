...
<div id="fue_user_report">
	<div class="col-left">
		...
		<table class="widefat fixed striped posts">
			<thead>
			<tr>
				<th scope="col" id="order" class="manage-column column-product" style="" width="60"><?php _e('Order', 'follow_up_emails'); ?></th>
				<th scope="col" id="email_name" class="manage-column column-email_name" style=""><?php _e('Email', 'follow_up_emails'); ?></th>
		...
		<table class="widefat fixed striped posts">
			...
			<tr>
				...
				<th scope="col" id="exclude_order" class="manage-column column-order" style=""><?php _e('Order', 'follow_up_emails'); ?></th>
